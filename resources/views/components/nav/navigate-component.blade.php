   <div class="header">
       <nav class="navbar top-navbar navbar-expand-md navbar-light">
           ...
           <div class="navbar-header">
               <a class="navbar-brand" href="index.html" style="margin-right: 25px;">
                   <!-- Logo icon -->
                   <b><img src="{{ asset('crm/images/LOGO_CERDO_VECTORIZADO.png') }}" alt="homepage" class="dark-logo"
                           width="70px" /></b>
                   <!--End Logo icon -->
                   <!-- Logo text -->
           ...
           <div class="navbar-collapse">
               ...
               <ul class="navbar-nav mr-auto mt-md-0">
                   ...
                   <!-- Messages -->
                   <li class="nav-item dropdown mega-menu"> <a class="nav-link dropdown-toggle text-muted  "
                           href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i
                               class="ti-wallet m-r-5"></i> Wallet</a>
                   ...
                   <li class="nav-item dropdown">
                       ...
                       <div class="dropdown-menu dropdown-menu-right mailbox animated slideInRight">
                           <ul>
                                   ...
                                   <div class="header-notify">
                                       ...
                                       <a href="#">
                                           ...
                                           <div class="notification-contnet">
                                               <h5>All Transaction BTC</h5> <span class="mail-desc">Just see the my
                                                   new admin!</span>
                                           </div>
                                       </a>
                                       <!-- Message -->
                                       <a href="#">
                                           ...
                                           <div class="notification-contnet">
                                               <h5>This is LTC coin</h5> <span class="mail-desc">Just a reminder
                                       ...
                                       <a href="#">
                                           ...
                                           <div class="notification-contnet">
                                               <h5>This is DASH coin</h5> <span class="mail-desc">You can customize
                                       ...
                                       <a href="#">
                                           ...
                                           <div class="notification-contnet">
                                               <h5>This is LTC coin</h5> <span class="mail-desc">Just see the my
                                                   admin!</span>
                                           </div>
                                       </a>
                                   </div>
                               ...
                               <li>
                                   <a class="nav-link text-center" href="javascript:void(0);"> Check all
                   ...
                   <li class="nav-item dropdown">
                       ...
                       <div class="dropdown-menu dropdown-menu-right mailbox animated slideInRight"
                           ...
                           <ul>
                               ...
                               <li>
                                   <a class="nav-link text-center" href="javascript:void(0);"> See all e-Mails <i
   ...
   <x-nav.navigate-header-component />
